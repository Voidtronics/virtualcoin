...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed.virtualcoin.sipa.be"); // Pieter Wuille, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("dnsseed.bluematt.me"); // Matt Corallo, only supports x9
        vSeeds.emplace_back("dnsseed.virtualcoin.dashjr.org"); // Luke Dashjr
        vSeeds.emplace_back("seed.virtualcoinstats.com"); // Christian Decker, supports x1 - xf
        vSeeds.emplace_back("seed.virtualcoin.jonasschnelli.ch"); // Jonas Schnelli, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("seed.btc.petertodd.org"); // Peter Todd, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("seed.virtualcoin.sprovoost.nl"); // Sjors Provoost

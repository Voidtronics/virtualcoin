...
/* A AEAD class for ChaCha20-Poly1305@virtualcoin.
 *
 ...
 *
 * The chacha20-poly1305@virtualcoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@virtualcoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@virtualcoin are relatively fast in

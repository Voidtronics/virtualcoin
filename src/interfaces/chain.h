...
//! internal workings of the virtualcoin node, and not being very convenient to use.
...
//!   asynchronously
//!   (https://github.com/virtualcoin/virtualcoin/pull/10973#issuecomment-380101269).
//!
//! * The initMessages() and loadWallet() methods which the wallet uses to send
//!   notifications to the GUI should go away when GUI and wallet can directly
//!   communicate with each other without going through the node
//!   (https://github.com/virtualcoin/virtualcoin/pull/15288#discussion_r253321096).
//!

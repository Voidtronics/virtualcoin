    ...
    mapper(nullptr)
{
    ...
    ui->virtualcoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->virtualcoinAtStartup);
    ...
    ui->virtualcoinAtStartup->setToolTip(ui->virtualcoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->virtualcoinAtStartup->setText(ui->virtualcoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openVirtualcoinConfButton->setToolTip(ui->openVirtualcoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new VirtualcoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->virtualcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openVirtualcoinConfButton_clicked()
{
    ...
    if (!GUIUtil::openVirtualcoinConf())

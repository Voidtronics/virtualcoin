    ...
    platformStyle(_platformStyle)
{
    ...
    // normal virtualcoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying virtualcoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &VirtualcoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);

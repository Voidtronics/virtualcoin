...
void TransactionView::changedAmount()
{
    ...
    if (VirtualcoinUnits::parse(model->getOptionsModel()->getDisplayUnit(), amountWidget->text(), &amount_parsed)) {
...
void TransactionView::exportClicked()
{
    ...
    writer.addColumn(VirtualcoinUnits::getAmountColumnTitle(model->getOptionsModel()->getDisplayUnit()), 0, TransactionTableModel::FormattedAmountRole);

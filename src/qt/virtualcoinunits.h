...
/** Virtualcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class VirtualcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit VirtualcoinUnits(QObject *parent);

    /** Virtualcoin units.
      @note Source: https://en.virtualcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        VTC,
...
typedef VirtualcoinUnits::Unit VirtualcoinUnit;

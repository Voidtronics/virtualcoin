...
static UniValue generatetodescriptor(const JSONRPCRequest& request)
{
    RPCHelpMan{
        ...
        "\nMine blocks immediately to a specified descriptor (before the RPC call returns)\n",
        {
            ...
            {"descriptor", RPCArg::Type::STR, RPCArg::Optional::NO, "The descriptor to send the newly generated virtualcoin to."},
...
static UniValue generatetoaddress(const JSONRPCRequest& request)
{
            RPCHelpMan{"generatetoaddress",
                "\nMine blocks immediately to a specified address (before the RPC call returns)\n",
                {
                    ...
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The address to send the newly generated virtualcoin to."},
                    {"maxtries", RPCArg::Type::NUM, /* default */ "1000000", "How many iterations to try."},
                },
                RPCResult{
            "[ blockhashes ]     (array) hashes of blocks generated\n"
            ...
            + "If you are running the virtualcoin core wallet, you can get a new address to send the newly generated virtualcoin to with:\n"
...
// NOTE: Unlike wallet RPC (which use VTC values), mining RPCs follow GBT (BIP 22) in using satoshi amounts
...
static UniValue getblocktemplate(const JSONRPCRequest& request)
{
            RPCHelpMan{"getblocktemplate",
                ...
                "    https://github.com/virtualcoin/bips/blob/master/bip-0022.mediawiki\n"
                "    https://github.com/virtualcoin/bips/blob/master/bip-0023.mediawiki\n"
                "    https://github.com/virtualcoin/bips/blob/master/bip-0009.mediawiki#getblocktemplate_changes\n"
                "    https://github.com/virtualcoin/bips/blob/master/bip-0145.mediawiki\n",
                {
...
static UniValue submitblock(const JSONRPCRequest& request)
{
    // We allow 2 arguments for compliance with BIP22. Argument 2 is ignored.
            RPCHelpMan{"submitblock",
                ...
                "See https://en.virtualcoin.it/wiki/BIP_0022 for full specification.\n",
                {

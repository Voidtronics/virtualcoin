 ...
 *  A CTxDestination is the internal data type encoded in a virtualcoin address
 */
...
/**
 * Generate a Virtualcoin scriptPubKey for the given CTxDestination. Returns a P2PKH

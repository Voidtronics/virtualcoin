...
{
    BOOST_CHECK(TestSplitHost("www.virtualcoincore.org", "www.virtualcoincore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.virtualcoincore.org]", "www.virtualcoincore.org", -1));
    BOOST_CHECK(TestSplitHost("www.virtualcoincore.org:80", "www.virtualcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.virtualcoincore.org]:80", "www.virtualcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:2627", "127.0.0.1", 2627));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:2627", "127.0.0.1", 2627));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:2627", "::ffff:127.0.0.1", 2627));
    BOOST_CHECK(TestSplitHost("[::]:2627", "::", 2627));
    BOOST_CHECK(TestSplitHost("::2627", "::2627", -1));
    BOOST_CHECK(TestSplitHost(":2627", "", 2627));
    BOOST_CHECK(TestSplitHost("[]:2627", "", 2627));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:2627", "127.0.0.1:2627"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:2627", "[::]:2627"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));

...
const char * const BITCOIN_CONF_FILENAME = "virtualcoin.conf";
 ...
 * https://github.com/virtualcoin/virtualcoin/pull/16097#issuecomment-514627823
 */
...
bool ArgsManager::ParseParameters(int argc, const char* const argv[], std::string& error)
{
    ...
    for (int i = 1; i < argc; i++) {
        ...
        if (key == "-") break; //virtualcoin-tx using stdin
        std::string val;
...
{
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Virtualcoin
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Virtualcoin
    // Mac: ~/Library/Application Support/Virtualcoin
    // Unix: ~/.virtualcoin
#ifdef WIN32
    // Windows
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Virtualcoin";
#else
    // Unix
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    // Make sure Virtualcoin Core copyright is not removed by accident
    if (copyright_devs.find("Virtualcoin Core") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + "The Virtualcoin Core developers";
    }

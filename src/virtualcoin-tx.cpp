...
static void SetupVirtualcoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " virtualcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  virtualcoin-tx [options] <hex-tx> [commands]  Update hex-encoded virtualcoin transaction\n" +
            "or:     virtualcoin-tx [options] -create [commands]   Create hex-encoded virtualcoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded virtualcoin transaction

...
{
    // If wallet doesn't have a chain (e.g virtualcoin-wallet), lock can't be taken.
    ...
    while (block_height && !fAbortRescan && !chain().shutdownRequested()) {
        ...
        if (chain().findBlock(block_hash, &block) && !block.IsNull()) {
            ...
            if (!locked_chain->getBlockHeight(block_hash)) {
                ...
                // https://github.com/virtualcoin/virtualcoin/pull/14711#issuecomment-458342518
                         ...
                         int& nChangePosInOut, std::string& strFailReason, const CCoinControl& coin_control, bool sign)
{
    ...
    int nBytes;
    {
        ...
        LOCK(cs_wallet);
        {
            ...
            // change transaction isn't always pay-to-virtualcoin-address
...
DBErrors CWallet::LoadWallet(bool& fFirstRunRet)
{
    ...
    // tx status. If lock can't be taken (e.g virtualcoin-wallet), tx confirmation
 ...
 * https://virtualcointalk.org/?topic=54527, or
 * https://github.com/virtualcoin/virtualcoin/pull/1393.
 */
